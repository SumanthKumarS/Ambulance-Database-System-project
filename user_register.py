...
class Register:
    def __init__(self, root):
        ...
        self.left = ImageTk.PhotoImage(file="images/reguserbck.jpg")
        left = Label(self.root, image=self.left, bg='deep sky blue').place(x=80, y=100, width=400, height=500)

        # register frame
        frame1 = Frame(self.root, bg='white')
        frame1.place(x=480, y=100, width=700, height=500)

        title = Label(frame1, text='USER REGISTER HERE', font=("times new roman", 20, "bold"), bg='white', fg='green').place(x=50,y=30)
        ...
        self.txt_dob = DateEntry(frame1 , font=('times new roman' , 15) , bg='white smoke')
        self.txt_dob.place(x=50, y=270 , width=250)
        date = self.txt_dob.get()
        if (date) :
        ...
        gender = Label(frame1, text='Gender', font=("times new roman", 15, "bold") , bg='white', fg='gray').place(x=370, y=240)
        ...
        btn_login = Button(self.root, text="Sign In",font=('times new roman', 15), bg='#d77337', fg='white', bd=0, cursor='hand2', command=self.Login_window).place(x=220, y=480, width=130)
    ...
    def register_data(self):
        ...
        if self.txt_f_name.get()=="" or self.txt_phone.get()=="" or self.txt_email.get()=="" or self.dbdate=="" or self.cmb_gender.get()=="Select" or self.txt_password.get()=="" or self.txt_cpassword.get()=="":
            ...
            try:
                ...
                if row!=None:
                    ...
                    cur.execute("insert into user (f_name,l_name,phone,email,dob, gender,password) values(%s,%s,%s,%s,%s,%s,%s)",
                                (
                                   self.txt_f_name.get(),
                                   self.txt_l_name.get(),
                                   self.txt_phone.get(),
                    ...
                    cur2.execute('insert into user_info (name,phone,email,dob,gender) values(%s,%s,%s,%s,%s)',
