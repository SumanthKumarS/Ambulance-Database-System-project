...
class Admin:
    def __init__(self,root):
        ...
        phone_txt.grid(row=3, column=1 , pady=10, padx=20, sticky='w')
        ...
        email_txt.grid(row=4, column=1 , pady=10 , padx=20 , sticky='w')
        ...
        cmb_quest = ttk.Combobox(frame1, textvariable=self.gender_var , font=('times new roman' , 12) , state='readonly' , justify=CENTER)
        cmb_quest['values'] = ("SELECT","Male" , "Female" , "Others")
        cmb_quest.grid(row=5 , column=1 , pady=10 , padx=20 , sticky='w')
        cmb_quest.current(0)
